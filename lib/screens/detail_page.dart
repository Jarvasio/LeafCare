                                ...
                                content: SingleChildScrollView(
                                  child: Center(
                                    child: plantList[widget.plantId].isSelected
                                        ? Text(
                                            'A planta ${plantList[widget.plantId].plantName} foi adicionada ao carrinho com sucesso',
                                            textAlign: TextAlign.justify,
                                            textDirection: TextDirection.rtl,
                                        ...
                                        : Text(
                                            'Removido ${plantList[widget.plantId].plantName} com sucesso do carrinho de compras',
                                            textAlign: TextAlign.justify,
                                            textDirection: TextDirection.rtl,
                                            style: const TextStyle(
                                              fontFamily: 'CloudSoftB',
